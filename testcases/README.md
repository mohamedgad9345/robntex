...
- `Module` — free-form string; see [`MODULES.md`](../MODULES.md) for the team's running
  list of known ROBIN modules (new ones get added as we encounter them).
...
- Never uses real personal data — uses clearly-fake placeholders (e.g. `TEST-QID-001`) and
  disposable emails (`qa.tester@example.com`).
...
- Single TC: `/execute-tc suite1/ROBIN-1001-eligibility-valid-qatar-id.md`
